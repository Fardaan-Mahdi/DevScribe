                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="submit" class="btn btn-primary-background text-white w-100">Login</button>
                            </form>
                        </div>
                        <div class="card-footer text-center bg-light-blue">
                            <small>Don't have an account? <a href="register.jsp" class="text-primary-background">Register here</a></small>
                        </div>
                    </div>
